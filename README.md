...
5 | If the area of the dilated image is than threshold then that images is classified as malarial infected sample.. Thresold = 100 | Area  = 937, So classified as **Malaria** ![](method1_steps/box.png).
